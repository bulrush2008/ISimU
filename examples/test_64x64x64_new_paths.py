"""
测试64x64x64网格插值，使用新的data_UNS目录结构
输出结果到data_matrix目录
"""
...
def main():
    ...
    # 输出文件路径
    output_h5 = "../data_matrix/dense_64x64x64_zero_assignment.h5"
    output_vts = "../data_matrix/dense_64x64x64_zero_assignment.vts"
    ...
    try:
        ...
        metadata = {
            ...
            'description': '64x64x64网格插值结果，使用新的data_UNS目录结构'
        }
